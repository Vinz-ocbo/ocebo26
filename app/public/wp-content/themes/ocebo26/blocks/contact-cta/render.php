...
$submit_label = esc_html( $attributes['submitLabel'] ?? '' );
$privacy_url  = esc_url( $attributes['privacyUrl'] ?? '/politique-confidentialite' );
?>
      ...
      <form class="contact-form" action="#" method="post" novalidate>
        ...
        <div class="contact-form__consent">
          <label class="form-checkbox">
            ...
            <span class="form-checkbox__text text-small">J'accepte que mes données soient utilisées pour répondre à ma demande conformément à la <a href="<?php echo $privacy_url; ?>">politique de confidentialité</a>.</span>
          </label>
        </div>
        <button type="submit" class="btn btn--primary btn--submit"><?php echo $submit_label; ?></button>
      </form>
    </div>
  </div>
</section>
